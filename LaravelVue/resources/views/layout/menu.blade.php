...
{{--                </li>--}}
{{--                <li>--}}
{{--                    <router-link active-class="" to="/dashboard"><i class="feather-home"></i><span>Hotel List</span></router-link>--}}
{{--                </li>--}}
{{--                <li>--}}
{{--                    <a href="mentee.html"><i class="feather-users"></i><span>User List</span></a>--}}
{{--                </li>--}}
{{--                <li>--}}
...
{{--                </li>--}}
{{--                <li>--}}
{{--                    <a href="transactions-list.html"><i--}}
